            ...
            <div class="container">
               ...
               <div class="nav-collapse collapse">
                  ...
                  <ul class="nav pull-right">
                     <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Yousef Shanawany <span class="label label-important">(1)</span> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
      ...
      <div class="container">
         <div class="media ">
            ...
            <div class="media-body span5" style="margin-bottom:20px">
               <h4 class="media-heading">Yousef Shanawany</h4>
